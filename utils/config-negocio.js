...
// ============================================
const NEGOCIO_ID_POR_DEFECTO = '6820bfa3-a0e8-4c4e-b935-62e59f717ecb'; // ID de Amy Nails
...
window.getTelefonoDuenno = async function() {
    const config = await window.cargarConfiguracionNegocio();
    return config?.telefono || '55513733';
};
...
window.getEmailNegocio = async function() {
    const config = await window.cargarConfiguracionNegocio();
    return config?.email || 'amandamartinez24amv@gmail.com';
};
